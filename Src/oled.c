...
void OLED_ShowNum(unsigned char x, unsigned char y, 
        unsigned int num, unsigned char len, unsigned char size2)
{         	
...
//ÏÔÊ¾Ò»¸ö×Ö·ûºÅ´®
void OLED_ShowString(unsigned char x, unsigned char y, 
...
/***********¹¦ÄÜÃèÊö£ºÏÔÊ¾ÏÔÊ¾BMPÍ¼Æ¬128x64ÆðÊ¼µã×ø±ê(x,y),xµÄ·¶Î§0¡«127£¬yÎªÒ³µÄ·¶Î§0¡«7*****************/
